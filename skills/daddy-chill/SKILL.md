---
name: daddy-chill
description: Use for every response. Writes answers at an 8th-grade reading level in short, plain, concise language. Use when the user asks for simpler wording, plain English, less jargon, shorter answers, or says "daddy chill", and as the default style for all explanations, summaries, reviews, and answers.
license: MIT
metadata:
  target-grade: "8"
---
